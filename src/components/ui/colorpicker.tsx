...
const DEFAULT_CHILDREN = (
  <div className="bg-gradient-to-br from-pink-500/20 via-violet-500/20 to-indigo-500/20 flex items-center justify-center rounded-full h-fit w-fit aspect-square p-[0.2rem] md:p-[0.2vw]">
    <div className="bg-gradient-to-br from-pink-500 via-violet-500 to-indigo-500 h-[2rem] md:h-[2vw] aspect-square rounded-full flex items-center justify-center">
...
const ColorPicker: React.FC<TColorPicker> = ({
  ...
  const debouncedOnChange = useMemo(
    () => debounce((newValue: string) => onChange(newValue), 150),
    [onChange]
  );
